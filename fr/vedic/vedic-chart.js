...
function renderPlanetTable(positions, lagnaSign, lagnaSidereal) {
    ...
    positions.forEach(p => {
        ...
        const roleMap = { Sun:'Soi/Autorité', Moon:'Émotions/Esprit', Mars:'Énergie/Courage', Mercury:'Intelligence/Communication', Jupiter:'Luck/Wisdom', Venus:'Amour/Charme', Saturn:'Patience/Responsabilité', Rahu:'Désir/Innovation', Ketu:'Spiritualité/Libération' };
...
function renderLucky(lagnaSign, moonPos) {
    ...
    const html = `<div class="interp-card">
        <div class="interp-text">
            ...
            <strong>🪐 Lagna Planète régnante:</strong> ${lagnaRulers[lagnaSign]}
        </div>
    </div>`;
