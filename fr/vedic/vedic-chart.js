...
function renderD9Interpretation(d9Positions, d9LagnaSign, d1LagnaSign) {
    ...
    html += `<div class="interp-card">
        <div class="interp-title">🕉️ D9 Lagna — Vous après le mariage : ${SIGNS[d9LagnaSign]} ${SIGN_SYMBOLS[d9LagnaSign]}</div>
    ...
    html += `<div class="interp-card">
        <div class="interp-title">💍 D9 7e maison — Caractère du conjoint : ${SIGNS[d9H7Sign]} ${SIGN_SYMBOLS[d9H7Sign]}</div>
        <div class="interp-text">
    ...
    html += `<div class="interp-card">
        <div class="interp-title">💼 D9 10e maison — But de vie (Dharma) : ${SIGNS[d9H10Sign]} ${SIGN_SYMBOLS[d9H10Sign]}</div>
        <div class="interp-text">
    ...
    html += `<div class="interp-card">
        <div class="interp-title">👔 Carrière du conjoint — 10e dérivée (D9 4e maison) : ${SIGNS[d9H4Sign]} ${SIGN_SYMBOLS[d9H4Sign]}</div>
        <div class="interp-text">
    ...
    html += `<div class="interp-card">
        <div class="interp-title">🧭 Direction du conjoint — Analyse à 6 indicateurs</div>
        <div class="interp-text">
    ...
    html += `<div class="interp-card">
        <div class="interp-title">🤝 Où vous rencontrez votre conjoint — D1 7e : ${SIGNS[d1H7ForMeeting]} ${SIGN_SYMBOLS[d1H7ForMeeting]}</div>
        <div class="interp-text">
    ...
    html += `<div class="interp-card">
        <div class="interp-title">🏛️ Origine familiale du conjoint — UL : ${SIGNS[ulSign]} ${SIGN_SYMBOLS[ulSign]}</div>
        <div class="interp-text">
    ...
    html += `<div class="interp-card">
        <div class="interp-title">👤 Première impression du conjoint — A7 : ${SIGNS[a7Sign]} ${SIGN_SYMBOLS[a7Sign]}</div>
        <div class="interp-text">
    ...
    html += `<div class="interp-card">
        <div class="interp-title">💎 Point d'attraction du conjoint — D9 Vénus : ${SIGNS[venusD9Sign]} ${SIGN_SYMBOLS[venusD9Sign]}</div>
        <div class="interp-text">
...
function renderDasha(moonNakshatra, birthDate, moonSidereal) {
    ...
    html += '🌙 Lune natale: <strong>' + nak.ko + ' (' + nak.name + ')</strong> — Premier Dasha: <strong>' + DASHA_KO[startRuler] + '</strong> (restant: ' + remainingYears.toFixed(2) + ' ans)</div></div>';
...
function renderDivisionalChart(positions, lagnaSidereal, division, chartId, interpId, label, koName) {
    ...
    if (division === 10) {
        ...
        html += '<div class="interp-card"><div class="interp-title">👶 D7 Analyse des Enfants</div><div class="interp-text">';
        ...
        html += '<div class="interp-card"><div class="interp-title">👨‍👩‍👧 D12 Analyse des Parents</div><div class="interp-text">';
        ...
        html += '📜 <strong>Parashara a dit :</strong> "Shashtiamsa (D60) is the most important of all divisional charts. Planets in benefic deity divisions give good results, malefic divisions give bad results."<br>';
        ...
        const careerKarma = ['Militaire/Leadership/Sports','Finance/Art/Agriculture','Education/Medias/Commerce','Nursing/Real Estate/Hotels','Politics/Entertainment/Management','Medical/Analysis/Service','Law/Diplomacy/Design','Research/Investigation/Medicine','Education/Religion/Foreign','Administration/Construction/Civil Service','Technologie/Science/Innovation','Art/Spirituality/Hospital'][d60H10sign];
        ...
        html += subChapter('🕉️', 'Liste des Divinités', ch7);
        ...
        html += '<div class="interp-card"><div class="interp-title">💰 D2 Hora — Analyse de Richesse</div><div class="interp-text">';
        ...
        html += '<div class="interp-card"><div class="interp-title">👫 D3 Drekkana — Fratrie et Courage</div><div class="interp-text">';
        ...
        html += '<div class="interp-card"><div class="interp-title">🏠 D4 Chaturthamsa — Propriété et Fortune</div><div class="interp-text">';
        ...
        html += '<div class="interp-card"><div class="interp-title">📚 D24 Chaturvimsamsa — Éducation</div><div class="interp-text">';
        ...
        if (jupD24) { const jH = ((jupD24.dSign - dLagnaSign + 12) % 12) + 1; html += '<br><strong>♃ Jupiter (Sagesse) → ' + jH + 'H:</strong> ' + ([1,4,5,9].includes(jH) ? '🎓 <strong>High academic achievement expected!</strong> Graduate school/PhD/study abroad possible.' : 'Growth through learning. Jupiter blessing in house ' + jH + '.') + '<br>'; }
        if (merD24) { const mH = ((merD24.dSign - dLagnaSign + 12) % 12) + 1; html += '<strong>☿ Mercure (Apprentissage) → ' + mH + 'H:</strong> ' + ([1,4,5,9].includes(mH) ? '📖 <strong>Outstanding intellectual ability!</strong> Talented in math, language, analysis.' : 'Intellectual ability expressed in house ' + mH + '.') + '<br>'; }
        html += '</div></div>';
