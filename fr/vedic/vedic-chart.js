        ...
        if (nak) {
            ...
            for (var i=0;i<9;i++) {
                ...
                if (now>=cd && now<endD) {
                    ...
                    html += '<div class="interp-card"><div class="interp-title">⏳ Ma période actuelle</div><div class="interp-text">Current period: <strong style="color:#c9a84c;">' + DASHA_KO[planet] + '</strong> period.<br><br>' + (dashaDesc[planet]||'') + '</div></div>';
                    break;
                }
                cd = endD;
            }
