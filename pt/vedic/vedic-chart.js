...
function renderInterpretation(positions, lagnaSign, moonPos) {
    ...
    if (moonPos && jupiter) {
        ...
        if (diff === 0 || diff === 3 || diff === 6 || diff === 9) {
            yogaText += isEasy ? '<strong>🐘 Bênção de Sabedoria & Fama</strong>' : '<strong>🐘 Gajakesari Yoga (Gajakesari)</strong> — Moon-Jupiter Kendra relationship! Wisdom, fame, abundance combination. Respected in society with outstanding intellect. Good education and children fortune.<br><br>';
        }
    }
    ...
    if (moonPos && mars && moonPos.sign === mars.sign) {
        yogaText += isEasy ? '<strong>🔥 Bênção de Vontade Forte & Riqueza</strong>' : '<strong>🔥 Chandra-Mangala Yoga</strong> — Moon-Mars same sign! Strong will and wealth accumulation. Success in business with bold decision-making.<br><br>';
    }
...
function renderDivisionalChart(positions, lagnaSidereal, division, chartId, interpId, label, koName) {
    ...
    if (division === 10) {
        ...
        const D60_DEITIES = [
            {name:'Ghora',nature:'malefic',desc:'Destruicao e medo. Karma sombrio de vidas passadas'},
            {name:'Rakshasa',nature:'malefic',desc:'Energia demoniaca. Forte desejo e apego'},
            {name:'Deva',nature:'benefic',desc:'Ser divino. Merito e bencaos de vidas passadas'},
            {name:'Kubera',nature:'benefic',desc:'Deus da riqueza. Karma de construcao de riqueza'},
            {name:'Yaksha',nature:'benefic',desc:'Guardiao da natureza. Harmonia com a natureza'},
            {name:'Kinnara',nature:'benefic',desc:'Musico celestial. Talento artistico'},
            {name:'Bhrashta',nature:'malefic',desc:'O caido. Karma de queda do alto'},
            {name:'Kulaghna',nature:'malefic',desc:'Destruidor de familias. Karma relacionado a familia'},
            ...
            {name:'Purishaka',nature:'malefic',desc:'Escravidao. Karma de restringir outros'},
            {name:'Apampathi',nature:'benefic',desc:'Senhor das aguas. Purificacao e cura'},
            {name:'Marut',nature:'benefic',desc:'Deus do vento. Liberdade e mudanca'},
            {name:'Kala',nature:'malefic',desc:'Deus do tempo. Karma do tempo e da morte'},
            {name:'Sarpa',nature:'malefic',desc:'Serpente. Escravidao e apego — incapaz de soltar'},
            {name:'Amrita',nature:'benefic',desc:'Nectar da imortalidade. Busca da vida eterna'},
            {name:'Indu',nature:'benefic',desc:'Lua. Sensibilidade e intuicao'},
            {name:'Mridu',nature:'benefic',desc:'O gentil. Gentileza e compaixao'},
            {name:'Komala',nature:'benefic',desc:'O delicado. Arte e beleza'},
            {name:'Heramba',nature:'benefic',desc:'Avatar de Ganesha. Superar obstaculos'},
            ...
            {name:'Bala',nature:'benefic',desc:'Forca. Fortaleza e coragem'},
            {name:'Vishwakarma',nature:'benefic',desc:'Arquiteto cosmico. Construcao e criacao'},
            {name:'Tamasa',nature:'malefic',desc:'Escuridao. Karma de ignorancia'},
            {name:'Kanchana',nature:'benefic',desc:'Ouro. Pureza e valor'},
            {name:'Varaha',nature:'benefic',desc:'Avatar javali de Vishnu. Salvacao'},
            {name:'Ramasala',nature:'benefic',desc:'Morada de Rama. Moralidade e dever'},
            {name:'Ghrisha',nature:'benefic',desc:'O radiante. Sabedoria e iluminacao'},
            {name:'Indra',nature:'benefic',desc:'Rei dos deuses. Lideranca'},
            {name:'Jala',nature:'benefic',desc:'Agua. Fluxo e adaptacao'},
            {name:'Vishwa',nature:'benefic',desc:'Universo. Amor universal'},
            {name:'Amara',nature:'benefic',desc:'Imortal. Busca da eternidade'},
            {name:'Bala2',nature:'malefic',desc:'Forca jovem. Uso imaturo do poder'},
            {name:'Pitri',nature:'malefic',desc:'Ancestrais. Karma ancestral'},
            {name:'Rudra',nature:'malefic',desc:'Deus da tempestade. Transformacao destrutiva'},
            {name:'Varuna',nature:'benefic',desc:'Deus do oceano. Ordem cosmica'},
            {name:'Aryama',nature:'benefic',desc:'Divindade solar. Amizade e contratos'},
            {name:'Mitra',nature:'benefic',desc:'Deus da amizade. Confianca e companheirismo'},
            {name:'Agni',nature:'malefic',desc:'Deus do fogo. Fogo purificador'},
            {name:'Varuna2',nature:'benefic',desc:'Deus do oceano. Sabedoria profunda'},
            {name:'Gauri',nature:'benefic',desc:'Parvati. Devocao e amor'},
            {name:'Mahakala',nature:'malefic',desc:'Grande Tempo. Tentando dominar o tempo'},
            {name:'Pitamaha',nature:'benefic',desc:'Grande Pai Brahma. Criador'},
            {name:'Kartikeya',nature:'benefic',desc:'Deus da guerra. Batalha justa'},
            {name:'Yama',nature:'malefic',desc:'Deus da morte. Julgamento e justica'},
            {name:'Kala2',nature:'malefic',desc:'Tempo. Perseguido pelo tempo'},
            {name:'Varuna3',nature:'benefic',desc:'Deus do oceano. Lei e verdade'},
            {name:'Kubera2',nature:'benefic',desc:'Deus da riqueza. Generosidade'},
            {name:'Aditya',nature:'benefic',desc:'Deus do sol. Luz e verdade'},
            {name:'Rishi',nature:'benefic',desc:'Sabio. Sabedoria e pratica'},
            {name:'Vasu',nature:'benefic',desc:'Ser celestial. Governando a natureza'},
            {name:'Ashwini',nature:'benefic',desc:'Curadores gemeos. Cura'},
            {name:'Naga',nature:'malefic',desc:'Divindade serpente. Misterio e segredos'},
            {name:'Gandharva',nature:'benefic',desc:'Musico celestial. Arte e musica'},
            {name:'Prajapati',nature:'benefic',desc:'Criador. Criando vida'},
        ...
        if (d16_4planets.length > 0) {
            d16_4planets.forEach(p => {
                html += isEasy ? (p.natural === 'benefic' ? 'Conforto material e felicidade abundantes!<br>' : 'Esforco necessario para conforto material.<br>') : '• ' + p.name + ': ' + (p.natural === 'benefic' ? 'Material comfort and happiness abundant!' : 'Effort needed for material comfort.') + '<br>';
            });
        ...
        if (d20_9planets.length > 0) {
            d20_9planets.forEach(p => { html += isEasy ? 'Forte conexao com mestre espiritual.<br>' : '• ' + p.name + ': Strong connection with spiritual teacher.<br>'; });
        ...
        } else html += isEasy ? 'Cresce constantemente em ambiente educacional estavel.<br>' : '4 house no planets.<br>';
        ...
        if (d24_5planets.length > 0) {
            d24_5planets.forEach(p => {
                html += isEasy ? (p.natural === 'benefic' ? 'Conquista excepcional em educacao superior!<br>' : 'Desafios academicos levam ao crescimento.<br>') : '• ' + p.name + ': ' + (p.natural === 'benefic' ? 'Outstanding higher education achievement!' : 'Academic challenges lead to growth.') + '<br>';
            });
        } else html += isEasy ? 'Esforco constante traz bons resultados.<br>' : '5 house no planets.<br>';

        if (jupD24) {
            const jH = ((jupD24.dSign - dLagnaSign + 12) % 12) + 1;
            html += (isEasy ? '<br>' : '<br><strong>♃ Jupiter (Wisdom) → ' + jH + 'th:</strong> ') + ([1,4,5,9].includes(jH) ? '🎓 <strong>Alto desempenho academico esperado!</strong> Pos-graduacao/doutorado/estudo no exterior possivel.' : (isEasy ? 'Crescimento por estudos esperado.' : 'Growth through academics. Jupiter\'s blessing manifests in ' + jH + 'th house area.')) + '<br>';
        }
        if (merD24) {
            const mH = ((merD24.dSign - dLagnaSign + 12) % 12) + 1;
            html += (isEasy ? '' : '<strong>☿ Mercury (Learning) → ' + mH + 'th:</strong> ') + ([1,4,5,9].includes(mH) ? '📖 <strong>Intelecto excepcional!</strong> Talento em matematica, linguas, analise.' : (isEasy ? 'Habilidade intelectual bem expressa.' : 'Intellectual ability in ' + mH + 'th house area.')) + '<br>';
        }
        html += '</div></div>';
        ...
        if (d27_6planets.length > 0) {
            d27_6planets.forEach(p => { html += isEasy ? 'Atencao especial necessaria para esta area.<br>' : '• ' + p.name + ' in 6th house — special attention needed for this area.<br>'; });
        }
        html += '</div></div>';
        ...
        if (d40_4planets.length > 0) {
            d40_4planets.forEach(p => { html += isEasy ? 'Energia fortemente herdada do lado materno.<br>' : '• ' + p.name + ': This planet\'s energy is strongly inherited from maternal line.<br>'; });
        ...
        if (d45_9planets.length > 0) {
            d45_9planets.forEach(p => { html += isEasy ? 'Energia fortemente herdada do lado paterno.<br>' : '• ' + p.name + ': This planet\'s energy is strongly inherited from paternal line.<br>'; });
