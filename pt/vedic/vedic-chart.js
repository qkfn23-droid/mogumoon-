        ...
        if (nak) {
            ...
            for (var i=0;i<9;i++) {
                ...
                if (now>=cd && now<endD) {
                    ...
                    html += '<div class="interp-card"><div class="interp-title">⏳ Meu Período Atual</div><div class="interp-text">Current period: <strong style="color:#c9a84c;">' + DASHA_KO[planet] + '</strong> period.<br><br>' + (dashaDesc[planet]||'') + '</div></div>';
                    break;
                }
                cd = endD;
            }
...
function renderSpouseProfile(d1LagnaSign, ulSign, a7Sign, venusD9Sign) {
    ...
    html += `<div class="interp-card">
        <div class="interp-title">${isEasy ? '🤝 Ambiente de Encontro' : '🤝 Meeting Environment — D1 7th: ' + SIGNS[d1H7ForMeeting] + ' ' + SIGN_SYMBOLS[d1H7ForMeeting]}</div>
        <div class="interp-text">
    ...
    html += `<div class="interp-card">
        <div class="interp-title">${isEasy ? '🏛️ Contexto Familiar do Parceiro' : '🏛️ Spouse Background — UL: ' + SIGNS[ulSign] + ' ' + SIGN_SYMBOLS[ulSign]}</div>
        <div class="interp-text">
    ...
    html += `<div class="interp-card">
        <div class="interp-title">${isEasy ? '👤 Primeira Impressão do Parceiro' : '👤 Spouse First Impression — A7: ' + SIGNS[a7Sign] + ' ' + SIGN_SYMBOLS[a7Sign]}</div>
        <div class="interp-text">
    ...
    html += `<div class="interp-card">
        <div class="interp-title">${isEasy ? '💎 Ponto de Atração do Parceiro' : '💎 Spouse Attraction — D9 Venus: ' + SIGNS[venusD9Sign] + ' ' + SIGN_SYMBOLS[venusD9Sign]}</div>
        <div class="interp-text">
...
function renderInterpretation(positions, lagnaSign, moonPos) {
    ...
    html += `<div class="interp-card">
        <div class="interp-title">${isEasy ? '💍 Meu Parceiro' : '💕 Spouse & Marriage — 7th House: ' + SIGNS[h7sign] + ' ' + SIGN_SYMBOLS[h7sign]}</div>
    ...
    html += `<div class="interp-card">
        <div class="interp-title">${isEasy ? '💼 Minha Carreira' : '💼 career & societyAchievement — 10th: ' + SIGNS[h10sign] + ' ' + SIGN_SYMBOLS[h10sign]}</div>
