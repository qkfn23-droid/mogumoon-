...
function renderDivisionalChart(positions, lagnaSidereal, division, chartId, interpId, label, koName) {
    ...
    if (division === 10) {
        ...
        const D60_DEITIES = [
            {name:'Ghora',nature:'malefic',desc:'Destrucción y miedo. Karma oscuro de vidas pasadas'},
            {name:'Rakshasa',nature:'malefic',desc:'Energía demoníaca. Fuerte deseo y apego'},
            {name:'Deva',nature:'benefic',desc:'Ser divino. Mérito y bendiciones de vidas pasadas'},
            {name:'Kubera',nature:'benefic',desc:'Dios de la riqueza. Karma de construcción de riqueza'},
            {name:'Yaksha',nature:'benefic',desc:'Guardián de la naturaleza. Armonía con la naturaleza'},
            {name:'Kinnara',nature:'benefic',desc:'Músico celestial. Talento artístico'},
            {name:'Bhrashta',nature:'malefic',desc:'El caído. Karma de caer desde lo alto'},
            {name:'Kulaghna',nature:'malefic',desc:'Destructor de familias. Karma relacionado con la familia'},
            {name:'Garala',nature:'malefic',desc:'Veneno. Karma de acciones tóxicas'},
            {name:'Vahni',nature:'malefic',desc:'Dios del fuego. Karma de ira y destrucción'},
            {name:'Maya',nature:'malefic',desc:'Ilusión. Karma de engaño'},
            {name:'Purishaka',nature:'malefic',desc:'Esclavitud. Karma de restringir a otros'},
            {name:'Apampathi',nature:'benefic',desc:'Señor de las aguas. Purificación y sanación'},
            {name:'Marut',nature:'benefic',desc:'Dios del viento. Libertad y cambio'},
            {name:'Kala',nature:'malefic',desc:'Dios del tiempo. Karma del tiempo y la muerte'},
            {name:'Sarpa',nature:'malefic',desc:'Serpiente. Esclavitud y apego — incapaz de soltar'},
            {name:'Amrita',nature:'benefic',desc:'Néctar de inmortalidad. Búsqueda de vida eterna'},
            {name:'Indu',nature:'benefic',desc:'Luna. Sensibilidad e intuición'},
            {name:'Mridu',nature:'benefic',desc:'Lo gentil. Gentileza y compasión'},
            {name:'Komala',nature:'benefic',desc:'Lo delicado. Arte y belleza'},
            {name:'Heramba',nature:'benefic',desc:'Avatar de Ganesha. Superar obstáculos'},
            {name:'Brahma',nature:'benefic',desc:'Dios creador. Creación y conocimiento'},
            {name:'Vishnu',nature:'benefic',desc:'Dios preservador. Protección y orden'},
            {name:'Maheshwara',nature:'benefic',desc:'Gran Señor Shiva. Transformación y liberación'},
            {name:'Deva2',nature:'benefic',desc:'Santo. Práctica espiritual'},
            {name:'Bala',nature:'benefic',desc:'Fuerza. Fortaleza y coraje'},
            {name:'Vishwakarma',nature:'benefic',desc:'Arquitecto cósmico. Construcción y creación'},
            {name:'Tamasa',nature:'malefic',desc:'Oscuridad. Karma de ignorancia'},
            {name:'Kanchana',nature:'benefic',desc:'Oro. Pureza y valor'},
            {name:'Varaha',nature:'benefic',desc:'Avatar jabalí de Vishnu. Salvación'},
            {name:'Ramasala',nature:'benefic',desc:'Morada de Rama. Moralidad y deber'},
            {name:'Ghrisha',nature:'benefic',desc:'Lo radiante. Sabiduría e iluminación'},
            {name:'Indra',nature:'benefic',desc:'Rey de los dioses. Liderazgo'},
            {name:'Jala',nature:'benefic',desc:'Agua. Fluir y adaptación'},
            {name:'Vishwa',nature:'benefic',desc:'Universo. Amor universal'},
            {name:'Amara',nature:'benefic',desc:'Inmortal. Búsqueda de eternidad'},
            ...
            {name:'Rudra',nature:'malefic',desc:'Dios de la tormenta. Transformación destructiva'},
            {name:'Varuna',nature:'benefic',desc:'Dios del océano. Orden cósmico'},
            {name:'Aryama',nature:'benefic',desc:'Deidad solar. Amistad y contratos'},
            ...
            {name:'Varuna2',nature:'benefic',desc:'Dios del océano. Sabiduría profunda'},
            {name:'Gauri',nature:'benefic',desc:'Parvati. Devoción y amor'},
            ...
            {name:'Varuna3',nature:'benefic',desc:'Dios del océano. Ley y verdad'},
            {name:'Kubera2',nature:'benefic',desc:'Dios de la riqueza. Generosidad'},
            {name:'Aditya',nature:'benefic',desc:'Dios del sol. Luz y verdad'},
            {name:'Rishi',nature:'benefic',desc:'Sabio. Sabiduría y práctica'},
            {name:'Vasu',nature:'benefic',desc:'Ser celestial. Gobernando la naturaleza'},
            {name:'Ashwini',nature:'benefic',desc:'Sanadores gemelos. Sanación'},
            {name:'Naga',nature:'malefic',desc:'Deidad serpiente. Misterio y secretos'},
            {name:'Gandharva',nature:'benefic',desc:'Músico celestial. Arte y música'},
