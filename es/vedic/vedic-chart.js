...
function renderDasha(moonNakshatra, birthDate) {
    ...
    let html = '<div class="interp-card" style="margin-bottom:12px;border-left:3px solid #c9a84c;"><div class="interp-text" style="font-size:12px;color:#888;">💡 <strong>Que es un Dasha?</strong> Life is divided into periods ruled by 9 planets in succession. During each planet\'s ruling period, that planet\'s energy strongly influences your life. The planet marked <strong style="color:#c9a84c;">Actual</strong> abajo es el que actualmente gobierna tu vida.</div></div>';
    ...
    for (let i = 0; i < 9; i++) {
        ...
        html += `<div class="dasha-item ${isActual ? 'current' : ''}">
            ...
            ${isActual ? '<span class="dasha-badge">Actual</span>' : ''}
        </div>`;
