...
function renderDasha(moonNakshatra, birthDate) {
    ...
    let html = '<div class="interp-card" style="margin-bottom:12px;border-left:3px solid #c9a84c;"><div class="interp-text" style="font-size:12px;color:#888;">💡 <strong>What is a Dasha?</strong> Life is divided into periods ruled by 9 planets in succession. During each planet\'s ruling period, that planet\'s energy strongly influences your life. The planet marked <strong style="color:#c9a84c;">Current</strong> below is the one currently governing your life.</div></div>';
...
function renderDivisionalChart(positions, lagnaSidereal, division, chartId, interpId, label, koName) {
    ...
    if (division === 10) {
        ...
        html += '⚠️ D30 reveals sources of misfortune and obstacles. Planet placement in 6th, 8th, and 12th houses is important.';
        html += '</div></div>';
    }
